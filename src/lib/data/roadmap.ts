...
const zhRoadmap: RoadmapPhase[] = [
  {
    ...
    title: '品牌建立与社群运营',
    items: [
      '建立「冻土回声」品牌视觉体系，搭建微信/QQ社群（600+人）',
...
const enRoadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Produce in-depth interviews and industry analysis content',
    ],
    status: 'in-progress',
  },
  {
    ...
    items: [
      'Expand Northeast Asia university alliance, host indie game expo',
  ...
  },
  {
    ...
    items: [
      'Build indie game publishing platform and developer fund',
...
const ruRoadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      'Расширение университетского альянса, проведение выставки инди-игр',
  ...
  },
  {
    ...
    items: [
      'Создание платформы для издания инди-игр и фонда разработчиков',
...
const mnRoadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      'Зүүн хойд Азийн их сургуулийн холбоог өргөжүүлэх, инди тоглоомын үзэсгэлэн зохион байгуулах',
  ...
  },
  {
    ...
    items: [
      'Инди тоглоом хэвлэлтийн платформ ба хөгжүүлэгчдийн санг байгуулах',
